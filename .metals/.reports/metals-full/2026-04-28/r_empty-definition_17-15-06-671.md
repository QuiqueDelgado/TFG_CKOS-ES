error id: file://<WORKSPACE>/tienda/src/main/java/com/tfg/tienda/service/PedidoService.java:_empty_/UsuarioRepository#
...
public class PedidoService {
    ...
    private final U@@suarioRepository usuarioRepo;
